<div class="tab-pane" id="accounts_listing" >
	  				<div class="listing_wrapper">
	  					<a href="#create_account" class="btn btn-default" data-toggle="modal">+ New Account</a>
	  					...
	  					<div class="btn-group bootstrap-select" style="width: 130px;margin-bottom: 0;">
		      				<button type="button" class="btn dropdown-toggle" data-toggle="dropdown" style="border: 1px solid #cccccc; border-radius: 4px;">
		      					<div class="filter-option pull-left">My Account</div>&nbsp;
		      					<div class="caret"></div>
		      				</button>
		      				<div class="dropdown-menu open">
		      					<ul class="dropdown-menu inner" role="menu">
		      						...
		      						<li rel="1">
		      							<a tabindex="0" class="" style="">
		      								<span class="text">All Account</span>
		      								<i class="glyphicon glyphicon-ok icon-ok check-mark"></i>
		      							</a>
		      						</li>
		      						<li rel="2">
